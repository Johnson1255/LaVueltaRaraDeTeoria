    ...
    public class MyParser
    {
        ...
        public Object CreateObjectFromNonterminal(NonterminalToken token)
        {
            switch (token.Rule.Id)
            {
                ...
                //Aca se debe llenar la cadena de errores
                case (int)RuleConstants.RULE_ID_ID :
                    {
                        ...
                        lista.Add(token.Tokens[0].UserObject);
                        return lista;
                    }
                ...
                case (int)RuleConstants.RULE_ID_ID_COMMA :
                    ...
                    foreach(Object valor in (ArrayList)token.Tokens[0].UserObject)
                    {
                        cadenaErrores += valor.ToString();
                    }
                return null;
        ...
        {
            System.Windows.Forms.MessageBox.Show("El codigo ha sido analizado correctamente!");
        }
    }
}
